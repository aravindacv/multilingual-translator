...
const KANJI = {
  ...
  "飲んでいます":"nonde imasu","飲んでいる":"nonde iru","飲んで":"nonde",
  "見ています":"mite imasu","見ている":"mite iru","見て":"mite",
  "聞いています":"kiite imasu","聴いています":"kiite imasu","聞いている":"kiite iru","聞いて":"kiite",
  "話しています":"hanashite imasu","話している":"hanashite iru","話して":"hanashite",
  "帰っています":"kaette imasu","帰っている":"kaette iru","帰って":"kaette",
  "起きています":"okite imasu","起きている":"okite iru","起きて":"okite",
  "寝ています":"nete imasu","寝ている":"nete iru","寝て":"nete",
  ...
  "として":"toshite","について":"nitsuite","によって":"niyotte",
  "います":"imasu","あります":"arimasu","ください":"kudasai",
  "している":"shite iru","します":"shimasu","でした":"deshita",
  "ました":"mashita","ません":"masen","ている":"te iru",
  "名前":"namae","仕事":"shigoto","日本語":"nihongo","英語":"eigo","言語":"gengo",
  "日本":"nihon","東京":"toukyou","大阪":"osaka","京都":"kyoto",
  "友達":"tomodachi","家族":"kazoku","子供":"kodomo","食べ物":"tabemono",
  "電車":"densha","飛行機":"hikouki","病院":"byouin","学校":"gakkou",
  "先生":"sensei","教師":"kyoushi","学生":"gakusei","医者":"isha",
  "音楽":"ongaku","映画":"eiga","世界":"sekai","時間":"jikan",
  "昨日":"kinou","今日":"kyou","明日":"ashita",
  "勉強":"benkyo","旅行":"ryokou","料理":"ryouri","天気":"tenki",
  "大学":"daigaku","会社":"kaisha","銀行":"ginkou",
  "楽しい":"tanoshii","悲しい":"kanashii","嬉しい":"ureshii","難しい":"muzukashii",
  "好き":"suki","嫌い":"kirai","大切":"taisetsu","有名":"yuumei",
  "語":"go","私":"watashi","僕":"boku","彼":"kare","彼女":"kanojo",
  "人":"hito","国":"kuni","時":"toki","今":"ima","前":"mae","後":"ato",
  "大":"dai","小":"shou","新":"shin","古":"ko","高":"kou",
  "食":"shoku","飲":"in","見":"mi","行":"i","来":"ki",
  "話":"hanashi","教":"oshi","働":"hataraki","遊":"aso",
  "店":"mise","駅":"eki","道":"michi","家":"ie","本":"hon",
  "水":"mizu","酒":"sake","茶":"cha","薬":"kusuri",
  "男":"otoko","女":"onna","子":"ko","父":"chichi","母":"haha",
  "海":"umi","山":"yama","川":"kawa","空":"sora","花":"hana",
  "一":"ichi","二":"ni","三":"san","四":"shi","五":"go",
  "六":"roku","七":"nana","八":"hachi","九":"kyuu","十":"juu",
  "朝":"asa","昼":"hiru","夜":"yoru",
};
const KANA = {
  "きゃ":"kya","きゅ":"kyu","きょ":"kyo","しゃ":"sha","しゅ":"shu","しょ":"sho",
  "ちゃ":"cha","ちゅ":"chu","ちょ":"cho","にゃ":"nya","にゅ":"nyu","にょ":"nyo",
  "ひゃ":"hya","みゃ":"mya","りゃ":"rya","りゅ":"ryu","りょ":"ryo",
  "ぎゃ":"gya","じゃ":"ja","じゅ":"ju","じょ":"jo","びゃ":"bya","ぴゃ":"pya",
  "あ":"a","い":"i","う":"u","え":"e","お":"o",
  "か":"ka","き":"ki","く":"ku","け":"ke","こ":"ko",
  "さ":"sa","し":"shi","す":"su","せ":"se","そ":"so",
  "た":"ta","ち":"chi","つ":"tsu","て":"te","と":"to",
  ...
  "ぱ":"pa","ぴ":"pi","ぷ":"pu","ぺ":"pe","ぽ":"po",
  "っ":"tt","ー":"-","、":", ","。":". ","・":" ",
  "キャ":"kya","シャ":"sha","シュ":"shu","ショ":"sho","チャ":"cha","チョ":"cho",
  "ジャ":"ja","ジュ":"ju","ジョ":"jo","ファ":"fa","フィ":"fi",
  "ア":"a","イ":"i","ウ":"u","エ":"e","オ":"o",
  "カ":"ka","キ":"ki","ク":"ku","ケ":"ke","コ":"ko",
  "サ":"sa","シ":"shi","ス":"su","セ":"se","ソ":"so",
  "タ":"ta","チ":"chi","ツ":"tsu","テ":"te","ト":"to",
...
function japaneseToRomaji(text) {
  if (!text) return "";
  const chars=[...text]; let result="",i=0;
  while(i<chars.length){
    let matched=false;
    for(let len=8;len>=1;len--){
      const chunk=chars.slice(i,i+len).join("");
      if(KANJI[chunk]){result+=" "+KANJI[chunk]+" ";i+=len;matched=true;break;}
    }
    if(matched)continue;
    const two=chars[i]+(chars[i+1]||"");
    if(KANA[two]){result+=KANA[two];i+=2;continue;}
...
// ─────────────────────────────────────────────────────────────────────────────
const AR_WORDS = {
  "mrhba":"marhaba","sbah":"sabah","msaa":"masa","msa":"masa",
  "asmy":"ismi","asmk":"ismuk","khyr":"khayr","shkra":"shukran","shkr":"shukr",
  "lljmy":"lil-jami","llmy":"lil-jami","aml":"amal","kmdrs":"ka-mudarris",
  "mdrs":"mudarris","kthyr":"kathir","jmyl":"jamil","kbyr":"kabir",
  "hyf":"kayfa","kyf":"kayfa","arafynda":"aravinda","tsbh":"tusbih",
  "mn":"min","fy":"fi","naam":"naem","aysh":"aysh","dwla":"dawla",
};
const AR_CHARS = {
  "\u0627":"a","\u0623":"a","\u0625":"i","\u0622":"aa","\u0671":"a",
  "\u0628":"b","\u062a":"t","\u062b":"th","\u062c":"j",
...
function arabicToLatin(text) {
  ...
  let out=[...s].map(ch=>AR_CHARS[ch]!==undefined?AR_CHARS[ch]:ch).join("");
  out=out.replace(/al--/g,"al-").replace(/\s+/g," ").trim();
  return out.split(" ").map(w=>{const c=w.replace(/[^a-zA-Z]/g,"").toLowerCase();return AR_WORDS[c]||AR_WORDS[w.toLowerCase()]||w;}).join(" ");
}

// ─────────────────────────────────────────────────────────────────────────────
// KANNADA
// ─────────────────────────────────────────────────────────────────────────────
const KN_C={"\u0c95":"k","\u0c96":"kh","\u0c97":"g","\u0c98":"gh","\u0c99":"n","\u0c9a":"ch","\u0c9b":"chh","\u0c9c":"j","\u0c9d":"jh","\u0c9e":"ny","\u0c9f":"t","\u0ca0":"th","\u0ca1":"d","\u0ca2":"dh","\u0ca3":"n","\u0ca4":"t","\u0ca5":"th","\u0ca6":"d","\u0ca7":"dh","\u0ca8":"n","\u0caa":"p","\u0cab":"ph","\u0cac":"b","\u0cad":"bh","\u0cae":"m","\u0caf":"y","\u0cb0":"r","\u0cb2":"l","\u0cb5":"v","\u0cb6":"sh","\u0cb7":"sh","\u0cb8":"s","\u0cb9":"h","\u0cb3":"l","\u0cbb":"r"};
const KN_V={"\u0cbe":"a","\u0cbf":"i","\u0cc0":"i","\u0cc1":"u","\u0cc2":"u","\u0cc6":"e","\u0cc7":"e","\u0cc8":"ai","\u0cca":"o","\u0ccb":"o","\u0ccc":"au"};
const KN_IV={"\u0c85":"a","\u0c86":"a","\u0c87":"i","\u0c88":"i","\u0c89":"u","\u0c8a":"u","\u0c8e":"e","\u0c8f":"e","\u0c90":"ai","\u0c92":"o","\u0c93":"o","\u0c94":"au"};
function kannadaToRoman(text){
  if(!text)return"";
  const VIR="\u0ccd",ANS="\u0c82",VIS="\u0c83";
  const chars=[...text];let result="",i=0;
  while(i<chars.length){
    const ch=chars[i],nxt=chars[i+1]||"";
    if(ch in KN_IV){result+=KN_IV[ch];i++;continue;}
    if(ch in KN_C){const c=KN_C[ch];if(nxt===VIR){result+=c;i+=2;}else if(nxt in KN_V){result+=c+KN_V[nxt];i+=2;}else{result+=c+"a";i++;}continue;}
    if(ch===ANS){result+="m";i++;continue;}
    if(ch===VIS){result+="h";i++;continue;}
    if(ch===VIR){i++;continue;}
    result+=ch===" "?" ":ch;i++;
...
// MALAYALAM
// ─────────────────────────────────────────────────────────────────────────────
const ML_C={"\u0d15":"k","\u0d16":"kh","\u0d17":"g","\u0d18":"gh","\u0d19":"ng","\u0d1a":"ch","\u0d1b":"chh","\u0d1c":"j","\u0d1d":"jh","\u0d1e":"ny","\u0d1f":"t","\u0d20":"th","\u0d21":"d","\u0d22":"dh","\u0d23":"n","\u0d24":"th","\u0d25":"th","\u0d26":"d","\u0d27":"dh","\u0d28":"n","\u0d2a":"p","\u0d2b":"ph","\u0d2c":"b","\u0d2d":"bh","\u0d2e":"m","\u0d2f":"y","\u0d30":"r","\u0d31":"r","\u0d32":"l","\u0d33":"l","\u0d34":"zh","\u0d35":"v","\u0d36":"sh","\u0d37":"sh","\u0d38":"s","\u0d39":"h"};
const ML_CHILLU={"\u0d7a":"n","\u0d7b":"n","\u0d7c":"r","\u0d7d":"l","\u0d7e":"l","\u0d7f":"k"};
const ML_V={"\u0d3e":"a","\u0d3f":"i","\u0d40":"i","\u0d41":"u","\u0d42":"u","\u0d43":"ru","\u0d46":"e","\u0d47":"e","\u0d48":"ai","\u0d4a":"o","\u0d4b":"o","\u0d4c":"au"};
const ML_IV={"\u0d05":"a","\u0d06":"a","\u0d07":"i","\u0d08":"i","\u0d09":"u","\u0d0a":"u","\u0d0b":"ru","\u0d0e":"e","\u0d0f":"e","\u0d10":"ai","\u0d12":"o","\u0d13":"o","\u0d14":"au"};
function malayalamToRoman(text){
  if(!text)return"";
  const VIR="\u0d4d",ANS="\u0d02",VIS="\u0d03";
  const chars=[...text];let result="",i=0;
  while(i<chars.length){
    const ch=chars[i],nxt=chars[i+1]||"",nxt2=chars[i+2]||"";
    if(ch==="\u0d28"&&nxt===VIR&&nxt2==="\u0d31"){const vs=chars[i+3]||"";result+=vs in ML_V?"ndr"+ML_V[vs]:"ndra";i+=vs in ML_V?4:3;continue;}
    if(ch in ML_CHILLU){result+=ML_CHILLU[ch];i++;continue;}
    if(ch in ML_IV){result+=ML_IV[ch];i++;continue;}
    if(ch in ML_C){const c=ML_C[ch];if(nxt===VIR){result+=c;i+=2;}else if(nxt in ML_V){result+=c+ML_V[nxt];i+=2;}else{result+=c+"a";i++;}continue;}
    if(ch===ANS){result+="m";i++;continue;}
    if(ch===VIS){result+="h";i++;continue;}
    if(ch===VIR){i++;continue;}
    result+=ch===" "?" ":ch;i++;
...
// Tested: namaste✓ suprabhat✓ dhanyavad✓ shubh ratri✓ pani✓ madad✓
// Key rule: word-final inherent 'a' is silent in Hindi (unlike Sanskrit)
// ─────────────────────────────────────────────────────────────────────────────
const HI_C = {
...
function hindiToRoman(text) {
  ...
  while (i < chars.length) {
    ...
    if (ch in HI_IV) {
      result += HI_IV[ch]; lastInherentA = false; i++; continue;
    }
    if (ch in HI_C) {
      const c = HI_C[ch];
      if (nxt === HI_VIRAMA) {
        result += c; lastInherentA = false; i += 2;
      } else if (nxt in HI_V) {
        result += c + HI_V[nxt]; lastInherentA = false; i += 2;
      } else {
        result += c + "a"; lastInherentA = true; i++;
      }
      continue;
    }
    if (ch === HI_ANUSVARA)     { result += "n";  lastInherentA = false; i++; continue; }
    if (ch === HI_VISARGA)      { result += "h";  lastInherentA = false; i++; continue; }
    if (ch === HI_CHANDRABINDU) { result += "n";  lastInherentA = false; i++; continue; }
    if (ch === HI_VIRAMA)       { i++; continue; }
    if (ch === HI_NUKTA)        { i++; continue; }
    if (ch === " ") {
      // Hindi: strip word-final inherent 'a' (it's silent)
      if (lastInherentA && result.endsWith("a")) result = result.slice(0,-1);
      result += " "; lastInherentA = false; i++; continue;
    }
    result += ch; lastInherentA = false; i++;
  }
  // Strip final inherent 'a'
  if (lastInherentA && result.endsWith("a")) result = result.slice(0,-1);
...
function transliterateAll(nativeResults) {
  return {
    japanese:  { native: nativeResults.japanese  || "", transliteration: japaneseToRomaji(nativeResults.japanese) },
    arabic:    { native: nativeResults.arabic    || "", transliteration: arabicToLatin(nativeResults.arabic) },
    kannada:   { native: nativeResults.kannada   || "", transliteration: kannadaToRoman(nativeResults.kannada) },
    malayalam: { native: nativeResults.malayalam || "", transliteration: malayalamToRoman(nativeResults.malayalam) },
    hindi:     { native: nativeResults.hindi     || "", transliteration: hindiToRoman(nativeResults.hindi) },
  };
}